...
RRBotSystemPositionOnlyHardware::configure(const hardware_interface::HardwareInfo & info)
{
...
hardware_interface::return_type RRBotSystemPositionOnlyHardware::start()
{
  ...
  for (int i = 0; i <= hw_start_sec_; i++) {
    ...
    RCLCPP_INFO(rclcpp::get_logger("RRBotSystemPositionOnlyHardware"), "%.1f seconds left...",
                hw_start_sec_ - i);
  }
  ...
  RCLCPP_INFO(rclcpp::get_logger("RRBotSystemPositionOnlyHardware"), "System Sucessfully started!");
...
hardware_interface::return_type RRBotSystemPositionOnlyHardware::stop()
{
  ...
  RCLCPP_INFO(rclcpp::get_logger("RRBotSystemPositionOnlyHardware"), "System sucessfully stopped!");
...
hardware_interface::return_type RRBotSystemPositionOnlyHardware::read()
{
  ...
  RCLCPP_INFO(rclcpp::get_logger("RRBotSystemPositionOnlyHardware"), "Joints sucessfully read!");
...
hardware_interface::return_type RRBotSystemPositionOnlyHardware::write()
{
  ...
  RCLCPP_INFO(rclcpp::get_logger("RRBotSystemPositionOnlyHardware"), "Joints sucessfully written!");
...
PLUGINLIB_EXPORT_CLASS(ros2_control_demo_hardware::RRBotSystemPositionOnlyHardware,
