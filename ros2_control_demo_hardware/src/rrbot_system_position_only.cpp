...
{
  if (ros2_control_components::BaseInterface<
    hardware_interface::components::SystemInterface>::configure(info) != return_type::OK) {
  ...
  //TODO(all): we should provide helpers for this checking somewhere
  {
