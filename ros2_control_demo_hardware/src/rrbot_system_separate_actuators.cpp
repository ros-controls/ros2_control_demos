...
{
hardware_interface::return_type RRBotModularJoint::configure(
...
RRBotModularJoint::export_state_interfaces()
{
...
RRBotModularJoint::export_command_interfaces()
{
...
hardware_interface::return_type RRBotModularJoint::start()
{
  ...
  for (int i = 0; i < hw_start_sec_; i++)
  {
    ...
    RCLCPP_INFO(
      rclcpp::get_logger("RRBotModularJoint"), "%.1f seconds left...",
      hw_start_sec_ - i);
  }
...
hardware_interface::return_type RRBotModularJoint::stop()
{
...
hardware_interface::return_type RRBotModularJoint::read()
{
  ...
  for (uint i = 0; i < hw_joint_states_.size(); i++)
  {
    ...
    RCLCPP_INFO(
      rclcpp::get_logger("RRBotModularJoint"), "Got state %.5f for joint %zu!",
