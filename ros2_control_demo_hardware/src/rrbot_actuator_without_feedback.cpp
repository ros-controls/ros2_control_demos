...
#include "ros2_control_demo_hardware/rrbot_actuator_without_feedback.hpp"
...
PLUGINLIB_EXPORT_CLASS(
  ros2_control_demo_hardware::RRBotActuatorWithoutFeedback, hardware_interface::ActuatorInterface)
