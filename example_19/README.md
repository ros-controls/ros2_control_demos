# ros2_control_demo_example_19
   ...
   This example demonstrates the joint_trajectory_controller's ``positions_upsampling`` feature, which upsamples positions-only VLA action chunks into smooth C2 cubic-spline commands.
