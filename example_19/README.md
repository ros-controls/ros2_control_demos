# ros2_control_demo_example_19
   ...
   This example demonstrates the InferenceBridgeController — a joint_trajectory_controller variant that upsamples positions-only VLA action chunks into smooth C2 cubic-spline commands.
