...
def generate_launch_description():
    ...
    rrbot_1_publisher_forward_position_controller_node = Node(
    ...
    rrbot_2_publisher_forward_position_controller_node = Node(
        package="ros2_controllers_test_nodes",
        executable="publisher_forward_position_controller",
        namespace="rrbot_2",
        name=["publisher_forward_position_controller"],
    ...
    return LaunchDescription(
        [
            rrbot_1_publisher_forward_position_controller_node,
            rrbot_2_publisher_forward_position_controller_node,
        ]
    )
