...
The complete URDF for the robot in this tutorial is available `here <https://github.com/ros-controls/ros2_control_demos/tree/{REPOS_FILE_BRANCH}/example_7/r6bot_description/urdf/r6bot.urdf>`__.
...
Open a terminal and launch the ``r6bot_controller.launch.py`` file from the ``r6bot_controller`` package.
